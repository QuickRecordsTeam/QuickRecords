...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            'name' => Permissions::CAN_CREATE_SUBSCRIPTION_PLAN,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_UPDATE_SUBSCRIPTION_PLAN,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_SUBSCRIPTION_PLANS,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_SUBSCRIPTION_PLAN,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_DELETE_SUBSCRIPTION_PLAN,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_CREATE_SUBSCRIPTION,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_UPDATE_SUBSCRIPTION,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_SUBSCRIPTIONS,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_SUBSCRIPTION,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_DELETE_SUBSCRIPTION,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_CREATE_PAYMENT,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_UPDATE_PAYMENT,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_PAYMENTS,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_PAYMENT,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_DELETE_PAYMENT,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        Permission::create([
            'name' => Permissions::CAN_GET_ORGANISATION_SUBSCRIPTIONS,
            'guard_name' => 'api',
            'id' => Str::uuid()->toString(),
            'updated_by' => 'info@quickrecords.net'
        ]);
        ...
        $role_admin->givePermissionTo([
            ...
            CustomPermission::findByName(Permissions::CAN_GET_USER_SAVINGS, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_INCOME_ACTIVITIES, 'api'),
            CustomPermission::findByName(Permissions::CAN_CREATE_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_UPDATE_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_ORGANISATION_SUBSCRIPTIONS, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_CREATE_PAYMENT, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_PAYMENTS, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_PAYMENT, 'api'),
        ]);
        ...
        $system_admin->givePermissionTo([
            CustomPermission::findByName(Permissions::CAN_CREATE_SUBSCRIPTION_PLAN, 'api'),
            CustomPermission::findByName(Permissions::CAN_UPDATE_SUBSCRIPTION_PLAN, 'api'),
            CustomPermission::findByName(Permissions::CAN_DELETE_SUBSCRIPTION_PLAN, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_SUBSCRIPTION_PLANS, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_SUBSCRIPTION_PLAN, 'api'),
            CustomPermission::findByName(Permissions::CAN_CREATE_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_UPDATE_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_SUBSCRIPTIONS, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_DELETE_SUBSCRIPTION, 'api'),
            CustomPermission::findByName(Permissions::CAN_CREATE_PAYMENT, 'api'),
            CustomPermission::findByName(Permissions::CAN_UPDATE_PAYMENT, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_PAYMENTS, 'api'),
            CustomPermission::findByName(Permissions::CAN_GET_PAYMENT, 'api'),
            CustomPermission::findByName(Permissions::CAN_DELETE_PAYMENT, 'api')
        ]);
    }
}

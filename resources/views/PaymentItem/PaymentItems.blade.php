        ...
        <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            @foreach ($payment_items as $key => $value)
                <tr style="border: 1px solid black; font-size: smaller">
                    ...
                    @if ($value->is_range == 1)
                        <td style="border: 1px solid black; padding: 3px;">{{ number_format($value->start_amount) }}</td>
                    @else
                    ...
                    @endif
                    <td style="border: 1px solid black; padding: 3px;font-size: smaller">
                        {{ str_replace('_', ' ', $value->frequency) }}</td>
                    <td style="border: 1px solid black; padding: 3px;font-size: smaller">
                        {{ str_replace('_', ' ', $value->type) }}</td>
                    <td style="border: 1px solid black; padding: 3px;">{{ date('d-m-Y', strtotime($value->deadline)) }}
                    </td>
                </tr>
                @if ($n % 25 == 0)
            ...
            <tr style="border: 1px solid black; font-size: smaller">
                ...
                <td style="border: 1px solid black; padding: 3px;font-weight: bold" colspan="5">
                    {{ number_format($total) }}
                    XAF</td>

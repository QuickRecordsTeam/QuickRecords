        ...
        <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            @foreach ($contributions as $key => $contribution)
                <tr style="border: 1px solid black; font-size: smaller">
                    ...
                    @if ($contribution->is_range)
                        <td style="border: 1px solid black; padding: 3px; text-align: center">
                            {{ number_format($contribution->start_amount) }} -
                            {{ number_format($contribution->end_amount) }}</td>
                    @else
                        <td style="border: 1px solid black; padding: 3px; text-align: center">
                    ...
                    <td style="border: 1px solid black; padding: 3px; text-align: center">
                        {{ isset($contribution->month_name) ? $contribution->month_name : '' }}</td>
                    <td style="border: 1px solid black; padding: 3px; text-align: center">
                        {{ isset($contribution->quarterly_name) ? $contribution->quarterly_name : '' }}</td>
                    <td style="border: 1px solid black; padding: 3px; text-align: center">
                        {{ isset($contribution->session->year)
                            ? $contribution->session->year
                            : \App\Models\Session::find($contribution->session)->year }}
                    </td>

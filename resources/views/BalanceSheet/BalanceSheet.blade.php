        ...
        <table style="border: 1px solid black; border-collapse: collapse;width: 100%">
            ...
            @foreach ($columns as $colum)
                <tr style="border: 1px solid black; font-size: smaller">
                    ...
                    <td style="padding: 3px; border: 1px solid black;">
                        {{ \App\Constants\Constants::SAVINGS == $colum->type ? 0 : number_format($colum->total_amount_deposited) }}
                        XAF
                    </td>
                    <td style="padding: 3px; border: 1px solid black;">
                        {{ \App\Constants\Constants::SAVINGS == $colum->type
                            ? 0
                            : number_format($colum->total_expect_amount - $colum->total_amount_deposited) }}
                        XAF
                    </td>
                    <td style="padding: 3px; border: 1px solid black;">
